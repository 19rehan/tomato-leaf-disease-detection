...
filepath = 'C:/Users/Rehan Akhter/Desktop/fyp rehan/model.h5'
model = load_model(filepath)
print(model)
\\\\\
print("Model Loaded Successfully")

tomato_plant = cv2.imread('C:/Users/Rehan Akhter/Desktop/fyp rehan/Dataset/test/Tomato___healthy (6).JPG')
